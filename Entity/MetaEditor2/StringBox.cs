...
{    
    public partial class StringBox : BaseField
    {
        #region Fields
        ...
        public void Populate(int iOffset, bool useMemoryStream)
        {
            ...
            this.textBox1.Size = new Size(this.textBox1.Size.Width, (this.Font.Height + 1) * this.textBox1.Lines.Length);
            this.Size = new Size(this.PreferredSize.Width, this.textBox1.Size.Height + 16);
