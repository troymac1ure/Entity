...
namespace entity.Main
{
    ...
    {        
        ...
        class FileData
        {
            ...
            public FileData(string data, DateTime dt)
            {
                Read(data, dt);
            }

            public void Read(string data, DateTime dt)
            {
                if (data[0] == 'd') 
                ...
                //string t = data.Substring(49, 12).Insert(6, ", " + DateTime.Now.Year.ToString());

                _date = dt; // DateTime.Parse(data.Substring(49, 12).Insert(6, ", " + DateTime.Now.Year.ToString()));
