// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TagBlock.cs" company="">
//   
// </copyright>
// <summary>
//   The tag block.
...
namespace MetaEditor.Components
{
    ...
    /// The tag block.
    /// </summary>
    public partial class TagBlock : BaseField
    {
        ...
        /// The e.
        /// </param>
        private void TagBlock_Enter(object sender, EventArgs e)
        {
        ...
        /// The e.
        /// </param>
        private void TagBlock_Leave(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// The update tag block boxes.
        /// </summary>
        private void UpdateTagBlockBoxes()
        {
